    ...
    const handleSignIn = async (data: FieldValues) => {
        ...
        const promise = new Promise(async (resolve, reject) => {
            const { data: res, error } = await signIn.email({
                    ...
                    onError: () => {
                        setBetterAuthError("Email ou mot de passe incorrect");
                        reject();
                    },
            });
        })
        ...
        toast.promise(promise, {
            ...
            error: 'Oops, une erreur s\'est produite lors de la connexion.'
        })
    }
        ...
        <div className="w-9/10 flex flex-col h-screen border-x m-auto relative">
            <main className="relative grow z-3 flex flex-col items-center gap-8 justify-center">
                <div className="text-center">
                    <h1 className="text-6xl font-buildTitling">Bon retour !</h1>
                    <p className="">Connectez-vous à votre compte Yukanime</p>
                </div>
                <div className="w-sm min-w-sm">
                    ...
                    <div className="text-center mt-4">
                        <p>Pas encore de compte ? <a href="/auth/sign-up" className="underline text-sm">Inscrivez-vous</a></p>
                    </div>
            ...
            <div className="absolute w-full inset-0 left-0 right-0 z-0 overflow-hidden">
                ...
                <Image className="blur-xs object-cover grayscale opacity-5 w-full h-full" src="/assets/2.jpg" alt="yukanime background" width={2000} height={2000} />
            </div>
